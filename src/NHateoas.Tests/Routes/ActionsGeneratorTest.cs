...
namespace NHateoas.Tests.Routes
{
    ...
    public class ActionsGeneratorTest
    {
        ...
        public void ComplexTest()
        {
            ...
            Assume.That(serialized, Is.EqualTo("[{\"name\":\"get-query\",\"class\":[\"__query\"],\"method\":\"GET\",\"href\":\"/api/1?query=:query\",\"fields\":[{\"name\":\"id\",\"value\":\"1\"},{\"name\":\"name\",\"value\":\"test\"},{\"name\":\"query\"},{\"name\":\"skip\"}]},{\"name\":\"put-prod\",\"method\":\"PUT\",\"href\":\"/api/prod/1\",\"fields\":[{\"name\":\"Id\",\"value\":\"1\"},{\"name\":\"Name\",\"value\":\"test\"},{\"name\":\"Price\",\"value\":\"5\"},{\"name\":\"email_address\",\"type\":\"email\",\"value\":\"abc@def.com\"}]}]"));
        }
    }
}
